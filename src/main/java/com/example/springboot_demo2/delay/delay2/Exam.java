package com.example.springboot_demo2.delay.delay2;
...
public class Exam {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < studentNumber; i++) {
            students.put(new Student("student"+(i+1), 1+random.nextInt(2),countDownLatch));
        }
...
class Student implements Runnable,Delayed{
    ...
    public Student(String name,long workTime,CountDownLatch countDownLatch){
        ...
        this.submitTime = TimeUnit.MILLISECONDS.convert(workTime, TimeUnit.MINUTES)+System.currentTimeMillis();
